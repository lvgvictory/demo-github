...
<html>
    <head>
        ...
        {{ Html::style('site/css/pignose.layerslider.css') }}
        <!-- //pignose css -->
        {{ Html::style('site/css/style.css') }}
        {{ Html::style('site/css/jquery-ui.css') }}
        {{ Html::style('site/css/flexslider.css') }}
        {{ Html::style('css/myCss.css') }}

        <!-- js -->
        {{ Html::script('library/jquery/dist/jquery-2.1.4.min.js')}}
        {{ Html::script('site/js/imagezoom.js') }}
        {{ Html::script('site/js/jquery.flexslider.js') }}
        {{ Html::script('site/js/jquery-ui.js') }}
        {{ Html::script('site/js/pignose.layerslider.js') }}
        {{ Html::script('site/js/responsiveslides.min.js') }}
        {{ Html::script('site/js/easyResponsiveTabs.js') }}
        {{ Html::script('js/myJs.js') }}
        <!-- //js -->
        <!-- cart -->
        {{ Html::script('site/js/simpleCart.min.js') }}
        <!-- cart -->
        ...
        {{ Html::script('site/js/jquery.easing.min.js')}}
        @yield('style')
    </head>
    <body>
        <!-- header -->
