<div class="header">
    <div class="container">
        <ul>
            ...
            <li><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span><a href="mailto:info@example.com">{{ trans('messages.info@example.com') }}</a></li>
        </ul>
    </div>
</div>
<!-- //header -->
...
<div class="header-bot">
    <div class="container">
        ...
        <div class="col-md-6 header-middle">
            <form>
                <div class="search">
                    <input type="search" value="{{ trans('messages.Search') }}" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Search';}" required="">
                </div>
