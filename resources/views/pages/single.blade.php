        ...
        <div class="col-md-6 single-right-left animated wow slideInUp animated slideInUp1" data-wow-delay=".5s" style="">
            <div class="grid images_3_of_2">
                <div class="flexslider">
                    ...
                    <!-- //FlexSlider-->
                    <ul class="slides">
                        <li data-thumb="site/images/d2.jpg">
                            <div class="thumb-image"> <img src="site/images/d2.jpg" data-imagezoom="true" class="img-responsive"> </div>
                        </li>
                        <li data-thumb="site/images/d1.jpg">
                            <div class="thumb-image"> <img src="site/images/d1.jpg" data-imagezoom="true" class="img-responsive"> </div>
                        </li>   
                        <li data-thumb="site/images/d3.jpg">
                            <div class="thumb-image"> <img src="site/images/d3.jpg" data-imagezoom="true" class="img-responsive"> </div>
                        </li>
                        <li data-thumb="site/images/d4.jpg">
                            <div class="thumb-image"> <img src="site/images/d4.jpg" data-imagezoom="true" class="img-responsive"> </div>
                        </li>   
                    </ul>
